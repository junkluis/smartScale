...
EstadisticasViewBase::EstadisticasViewBase()
{
    backgroundmenu.setXY(0, 0);
    backgroundmenu.setBitmap(touchgfx::Bitmap(BITMAP_BACKGROUND_TITLE_ID));

    txt_tituloEstad.setXY(20, 24);
    txt_tituloEstad.setColor(touchgfx::Color::getColorFrom24BitRGB(255, 255, 255));
    txt_tituloEstad.setLinespacing(0);
    txt_tituloEstad.setTypedText(touchgfx::TypedText(T_SINGLEUSEID38));
...
void EstadisticasViewBase::setupScreen()
{
